const URL = "https://api.openweathermap.org/data/2.5/weather?lat=40.5308&lon=-112.2983&appid=a6e100d4acc39477dd37c1f40f6c2361&units=imperial";
...
fetch(URL).then((response) => response.json()).then((jsObject) => {
